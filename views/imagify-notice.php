...
<a href="<?php echo esc_url( $rll_dismiss_url ); ?>" class="rktll-cross"><span class="dashicons dashicons-no"></span></a>

<p class="rktll-imagify-logo">
	<img src="<?php echo esc_url( Config::get( 'assets_url' ) . 'img/logo-imagify.png' ); ?>" srcset="<?php echo esc_attr( Config::get( 'assets_url' ) . 'img/logo-imagify.svg 2x' ); ?>" alt="Imagify" width="150" height="18">
</p>
...
<p class="rktll-imagify-cta">
	<a data-slug="imagify" href="<?php echo esc_url( $rll_action_url ); ?>" class="button button-primary install-now"><?php esc_html_e( 'Install Imagify for Free', 'rocket-lazy-load' ); ?></a>
</p>
</div>
