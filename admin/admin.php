		...
		<div class="rocket-lazyload-body">
			...
			<div class="rocket-lazyload-cross-sell">
				...
				<div class="rocket-lazyload-ads">
					<a href="https://wp-rocket.me"><img src="<?php echo ROCKET_LL_ASSETS_URL ?>img/wp-rocket@2x.jpg" alt="WP Rocket" width="393" height="180"></a>
					<a href="https://imagify.io"><img src="<?php echo ROCKET_LL_ASSETS_URL ?>img/imagify@2x.jpg" alt="Imagify" width="393" height="180"></a>
				</div>
			</div>
		</div>
	</div>
